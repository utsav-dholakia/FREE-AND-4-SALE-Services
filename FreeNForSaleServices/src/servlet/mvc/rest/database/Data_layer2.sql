...
-- User
Insert into  User (UId,Name,Bdate,Phone,Email,Street,City,StateId,Zipcode,Sex,SSN,LastLoginTime,FailedAttempts,ProfilePhoto) values (1, 'Utsav', '1992-05-05', '4697345790', 'uvd@gmail.com', '7650 McCallum', 'Dallas', 45, 75252, 'M',, Now(), 0, '');
